  ...
  if (isMinimized) {
    return (
      <Button
        ...
        className="fixed bottom-6 right-6 h-14 w-14 rounded-full bg-primary shadow-lg hover:bg-primary/90 p-0 flex items-center justify-center transition-all duration-200"
      >
